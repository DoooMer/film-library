...
class Ui_FilmForm(object):
    def setupUi(self, FilmForm):
        ...
        self.diskLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.diskInput.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.titleLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.titleInput.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.yearLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.yearInput.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.genreLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.genreInput.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.directorLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.directorInput.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.roleLabel.setMinimumSize(QtCore.QSize(0, 37))
        ...
        self.roleInput.setMinimumSize(QtCore.QSize(0, 37))
